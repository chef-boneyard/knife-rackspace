...
Files can be injected onto the provisioned system using the `--file` switch. For example to inject `my_script.sh` into `/root/initialize.sh` you would use the following switch
